...
<BODY>  
        <script>   
         function formSubmit1(){    
             document.actionForm1.action = "report_out_month.php";    
             document.actionForm1.submit();    
         }    
         function formSubmit11(){    
             document.actionForm11.action = "report_out_month.php";    
             document.actionForm11.submit();    
         }  
         function formSubmit2(){    
             document.actionForm2.action = "report_out_month.php";    
             document.actionForm2.submit();    
         }    
         function formSubmit21(){    
             document.actionForm21.action = "report_out_month.php";    
             document.actionForm21.submit();    
         }    
         function formSubmit22(){    
             document.actionForm22.action = "report_out_month.php";    
             document.actionForm22.submit();    
         }    
         function formSubmit4(){    
             document.actionForm4.action = "report_out_month.php";    
             document.actionForm4.submit();    
         }
         <?PHP  $result = $Finance->getReportOutMonthTotal($date);
                $user = "";
                foreach( $result  as  $key => $value )
                {
                    ...
                    if ( $user == $value[2] )
                    {
                        ...
                        echo "document.actionForm5".$key.".action = \"report_out_month.php\";\n";    
                        echo "document.actionForm5".$key.".submit();\n";    
                        echo "}\n";

                        echo "function formSubmit3".$key."(){\n";    
                        echo "document.actionForm3".$key.".action = \"report_out_month.php\";\n";    
...
?> 
            ...
            <?PHP
                $result = $Finance->getReportOutMonth($date);
                foreach( $result  as  $key => $value )
                {
                        $key1 = $key;
...
<?php
            ...
            $result = $Finance->getReportPersonOutMonth($user_id2,$date);
            foreach( $result  as  $key => $value )
                {
                        $key1 = $key;
                        $total_money = $total_money + $value[1];
...
<?PHP    
    ...
    $result = $Finance->getReportOutMonthTotal($date);
    foreach( $result  as  $key => $value )
    {
