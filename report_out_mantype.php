...
<BODY>  
        <script>   
         ...
         function formSubmit21(){    
             document.actionForm21.action = "report_out_mantype.php";    
             document.actionForm21.submit();    
         }    
         function formSubmit22(){    
             document.actionForm22.action = "report_out_mantype.php";    
