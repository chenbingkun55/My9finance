...
<BODY>  
        <script>   
         function formSubmit1(){    
             document.actionForm1.action = "report_out_addr_year.php";    
             document.actionForm1.submit();    
         }    
         function formSubmit11(){    
             document.actionForm11.action = "report_out_addr_year.php";    
             document.actionForm11.submit();    
         }  
         function formSubmit2(){    
             document.actionForm2.action = "report_out_addr_year.php";    
             document.actionForm2.submit();    
         }    
         function formSubmit21(){    
             document.actionForm21.action = "report_out_addr_year.php";    
             document.actionForm21.submit();    
         }    
         function formSubmit22(){    
             document.actionForm22.action = "report_out_addr_year.php";    
             document.actionForm22.submit();    
         }    
         function formSubmit4(){    
             document.actionForm4.action = "report_out_addr_year.php";    
	 	...
	 	$addr_id2 = "";
                foreach( $result  as  $key => $value )
                {
                    if ( $addr_id2 == $value[3] )
                    {
                        ...
                        echo "document.actionForm3".$key.".action = \"report_out_addr_year.php\";\n";    
            ...
            <tr>
                <td colspan="9" align="center">
                    ...
                    <form name="actionForm1" method="POST" style="display: inline;">   
                        ...
                        <a href="javascript:frmSubmit1()">上一年</a>  
                    </form>
